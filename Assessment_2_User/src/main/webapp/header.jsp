        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.jsp"><span class="log-w3pvt">Assessement 2</a> <label class="sub-des">Student Management</label></h1>
                    </div>

                    <div class="forms ml-auto">
                        <a href="signin.jsp" class="btn"><span class="fa fa-user-circle-o"></span> Sign In</a>
