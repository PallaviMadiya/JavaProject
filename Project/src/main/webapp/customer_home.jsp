         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <%for(ProductModel p : list){ %>
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="image/<%=p.getImage() %>" class="img-thumbnail" alt="" width="300px" height="300px">
                  <div class="banner-right-icon">
                  	<a href="single_product.jsp?id=<%=p.getPid()%>">
                     <h4 class="pt-3"><%=p.getPname() %></h4></a>
                     <h3 class="pt-3"><%=p.getPprice() %></h3>
                  </div>
               </div>
               <%} %>
            </div>
