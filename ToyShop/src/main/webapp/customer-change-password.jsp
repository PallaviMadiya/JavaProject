				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav ">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="nav-link" href="customer-profile.jsp">Profile</a> <a
									class="nav-link " href="customer-change-password.jsp">Change
									Password</a> <a class="nav-link " href="customer-logout.jsp">Logout</a>
							</div></li>
					</ul>
				</div>
			</nav>
